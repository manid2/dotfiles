# Code borrowed from ohmyzsh/plugins/git plugin
# Modified to suit my specific needs.
# Use this along with `git-sh-prompt` script from git-core
#
# Retain the original document comments as they are found in OMZ git plugin
# modify only if needed and mention these modifications with suffix [Mani].
#
